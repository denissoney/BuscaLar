      ...
      >
        <View style={styles.card}>
          ...
          <View style={styles.sobreContainer}>
            <Text style={styles.sobreTitle}>
              Sobre
            </Text>

            <Text style={styles.sobreText}>
              Proprietário parceiro desde 2021.
              Comprometido em oferecer imóveis
              bem cuidados e atendimento rápido
              aos inquilinos. Sempre disponível
          ...
          <View style={styles.imoveisHeader}>
            <Text style={styles.imoveisTitle}>
              Meus Imóveis
            </Text>
          ...
          >
            ...
            >
              <Image
                ...
                style={styles.imovelImg}
              />

              <View style={styles.imovelInfo}>
                <Text style={styles.imovelNome}>
                  • Apartamento Ponta Verde{"\n"}
                  2 quartos - 68m²
                </Text>

                <Text style={styles.imovelPreco}>
                  R$ 1.200/mês
                </Text>
              </View>
            </TouchableOpacity>
            ...
            <View style={styles.avaliacaoCard}>
              <View style={styles.avaliacaoHeader}>
                <View style={styles.avaliacaoAvatar}>
                  <Text
                    style={styles.avaliacaoAvatarText}
                  >
                    R
                  </Text>
                </View>
                ...
                >
                  ...
                  <Text
                    style={styles.avaliacaoEstrelas}
                  >
                    ★★★★★
                  </Text>
                </View>

                <Text style={styles.avaliacaoTempo}>
                  Há 2 semanas
                </Text>
              </View>

              <Text style={styles.avaliacaoTexto}>
                Excelente proprietário! Muito
                atencioso, respondeu rapidamente
                e o imóvel era exatamente como
                descrito.
              </Text>
            </View>
        ...
        >
          ...
          <Text style={styles.btnContatoText}>
            Entrar em contato
          </Text>
        </TouchableOpacity>
      </ScrollView>
