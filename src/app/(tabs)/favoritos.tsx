      ...
      <View style={styles.content}>
        <View style={styles.voltarRow}>
          ...
          <View>
            ...
            {/* LINHA LARANJA LISA GROSSA NO INICIO FINA NO FINAL */}
            <Svg height={4} width={75} style={{ marginTop: 3 }}>
              <Polygon points="0,0 75,1 75,2 0,4" fill="#FF8C00" />
            </Svg>
          </View>
        </View>
        ...
        <View style={styles.abasContainer}>
          <TouchableOpacity style={[styles.aba, aba === "Mensal" && styles.abaAtiva]} onPress={() => setAba("Mensal")}>
            <Text style={[styles.abaTexto, aba === "Mensal" && styles.abaTextoAtivo]}>Mensal</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.aba, aba === "Diarias" && styles.abaAtiva]} onPress={() => setAba("Diarias")}>
            <Text style={[styles.abaTexto, aba === "Diarias" && styles.abaTextoAtivo]}>Diarias</Text>
          </TouchableOpacity>
        </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100, paddingTop: 6 }}>
          {lista.map((item) => (
            <View key={item.id} style={[styles.card, styles.sombra]}>
              ...
              <TouchableOpacity style={styles.btnHeart} onPress={() => remover(item.id)}>
...
const styles = StyleSheet.create({
  ...
  abasContainer: { flexDirection: "row", marginHorizontal: 12, marginTop: 14, backgroundColor: "#E9E9E9", borderRadius: 12, padding: 4 },
  ...
  card: { flexDirection: "row", marginHorizontal: 12, marginTop: 10, backgroundColor: "#FFF", borderRadius: 10, borderWidth: 1, borderColor: "#E5E5E5", padding: 8, alignItems: "center" },
  cardImg: { width: 85, height: 75, borderRadius: 8 },
  cardInfo: { flex: 1, marginLeft: 10, gap: 2 },
